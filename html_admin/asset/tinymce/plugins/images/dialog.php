...
<title>Chèn hình ảnh nhanh -  CMS</title>
...
<body class="images">
    <form id="upload" action="/api/upload" method="post" enctype="multipart/form-data" style="margin: 0;">
        <div class="box-drop-drag" id="drop" style="display: none;">
            <input type="file" multiple="true" accept=".jpg,.png,.jpeg,.gif" name="upl" value="" class="hide" id="inp_upload" />
        </div>
    </form>
    <div class="list_uploading" style="display: none;">
        <h4>đang tải lên từ máy tính ...</h4>
        <ul id="js_append_html" class="list_img"></ul>
    </div>
    <div id="history">
        <form action="" method="get" style="margin: 6px;">
            ...
            <select class="m-wrap" name="all_user" style="width: 123px;">
                <option value="0">Ảnh của tôi</option>
