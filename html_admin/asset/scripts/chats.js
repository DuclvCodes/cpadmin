$(document).ready(function(){
    ...
    function open_chat(room) {
        if($('#nodeChat_'+room).length) $('#nodeChat_'+room).addClass('focus');
            ...
            $('#tkp_chat_extention').append('<div id="nodeChat_'+room+'" class="nodeChat portlet box grey"><div class="portlet-title bar_move"><div class="caption"><i class="icon-comment"></i> <span class="letter">'+title+'</span></div><div class="tools"> <a href="#" class="collapse"></a><a href="#" class="config"></a> <a href="#" class="remove btn_close"></a> </div></div><div class="js_scoll"><div class="portlet-body"><ul class="chats"><li style=" text-align: center; width: 100%; "><a href="#" class="btn_loadmore" data-mid="0">Tải thêm tin nhắn cũ</a><img src="/asset/img/input-spinner.gif" style="display: none;"></li></ul></div></div><div class="chatFoot"><div class="chat-form"><div class="input-cont"><input class="m-wrap inp_text" type="text" placeholder="Type a message here..."></div><div class="btn-cont"><span class="arrow"></span><a href="" class="btn blue icn-only btn_send" data-room="'+room+'"><i class="icon-ok icon-white"></i></a></div></div></div><div class="chatPopup"><div class="win_user"></div><div class="win_invite"></div></div></div>');
