    ...
    echo $msg;
                                ...
                                <div class="portlet box blue tabbable">
                                    ...
                                    <div class="portlet-body form" style="padding: 8px;">
                                        <textarea name="content" maxlength="5000" class="m-wrap span12 js_upload" rows="20" ></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group" id="field_intro" style="display: none;">
									...
									<div class="controls">
                                        <textarea name="intro" maxlength="1000" id="f_intro" class="m-wrap span12" rows="20" ></textarea>
									</div>
								</div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6">
                                                <div class="control-group">
                									...
                									<div class="controls">
                										<input name="width" maxlength="4" type="text" id="f_width" class="m-wrap span12" value="" />
                									</div>
                								</div>
                                            </div>
                                            <div class="span6">
                                                <div class="control-group">
                									...
                									<div class="controls">
                										<input name="height" maxlength="3" type="text" id="f_height" class="m-wrap span12" value="" />
                									</div>
                								</div>
                                            </div>
                                        </div>
