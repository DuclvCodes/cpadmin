...
<div class="modal-body">
    <form id="form_default_modal" class="form-horizontal" action="/<?=$mod?>/add" method="post" enctype="multipart/form-data">
        <div class="row-fluid">
    		<div class="span10">
                <div class="control-group">
                    <label class="control-label" for="f_title">Tiêu đề</label>
        			<div class="controls">
        				<input maxlength="255" name="title" type="text" id="f_title" class="m-wrap span12 required" value="<?php echo $title ?>" />
        			</div>
        		</div>
                <div class="control-group">
                    <label class="control-label" for="f_email">Email</label>
        			<div class="controls">
        				<input maxlength="50" name="email" type="text" id="f_email" class="m-wrap span12 required" value="<?php echo $email ?>" />
        			</div>
        		</div>
                <div class="control-group">
                    <label class="control-label" for="f_title">Nhóm</label>
        			<div class="controls">
        				<?php echo $clsClassTable->getSelect('parent_id', 0, 'm-wrap span12', '-- Chọn --', true) ?>
        			</div>
        		</div>
