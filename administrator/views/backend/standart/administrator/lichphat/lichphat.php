...
<div class="page-container row-fluid">
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					<h3 class="page-title">
						Lịch phát sóng
                        <form action="" method="get" style="display: inline-block; width: 200px;">
                            <input type="hidden" name="mod" value="lichphat" />
    ...
    ?>
        ...
        echo 'selected="selected"';
                        ...
                        <a href="#" data-href="/<?php echo $mod ?>/add?parent_time=<?=$parent_time?>" class="btn_modal btn green pull-right"><i class="icon-plus"></i> Thêm mới</a>
					</h3>
        ...
        ?>
                    ...
                    <table class="table table-bordered table-advance act_default" id="sample_1">
						<thead>
							<tr>
								<th class="background_white">Time</th>
...
$(document).ready(function(){
    ...
    $('select[name=parent_time]').change(function(){
