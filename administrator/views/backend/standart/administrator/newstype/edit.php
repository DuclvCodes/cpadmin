...
<div class="page-container row-fluid">
	...
	<div class="page-content">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					<h3 class="page-title">
						Quản lý loại bài viết <small><?php echo $title ?></small>
                        <a href="/newstype/add" class="btn green pull-right">Thêm mới <i class="icon-plus"></i></a>
					</h3>
					<ul class="breadcrumb">
						<li>
							<i class="icon-home"></i>
						...
						<li>
							<a href="/<?php echo $mod ?>">Loại bài viết</a>
							<i class="icon-angle-right"></i>
						</li>
    ...
    echo $msg;
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <textarea name="description" id="f_intro_detail" class="m-wrap span12" rows="3" ><?php echo $description ?></textarea>
                                </div>
                            </div>
                            </div>
                            <!--/span-->
    ...
    ?>
        ...
        ?>
                                <div class="portlet box blue">
        							...
        							<div class="portlet-body">
                                        <div class="controls controls-row">
                                            <a href="/newstype/delete?id=<?php echo $_GET['id'] ?>" title="" class="btn_trash">Xóa vĩnh viễn</a>
                                            <a href="/newstype/restore?id=<?php echo $_GET['id'] ?>" class="btn green pull-right"><i class="icon-undo"></i> Phục hồi</a>
                                        </div>                                                                                                                                                     
        							</div>
        						</div>
                                <?php
