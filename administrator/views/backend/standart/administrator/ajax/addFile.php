...
<div style="padding: 15px;">
    <div class="row-fluid">
    	...
    	<form action="/ajax/addFile" method="post" enctype="multipart/form-data" class="horizontal-form" id="form_default" style="font-family: Arial;">
    ...
    echo 'checked="checked"';
            ...
            <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                            <textarea name="note" id="f_intro_detail" class="m-wrap span12" rows="3" ></textarea>
                    </div>
                </div>
            <div class="control-group">
