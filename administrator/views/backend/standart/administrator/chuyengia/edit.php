	...
	<div class="page-content">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					<h3 class="page-title">
						Quản lý chuyên gia <small><?php echo $title ?></small>
                        <a href="/chuyengia/add" class="btn green pull-right">Thêm mới <i class="icon-plus"></i></a>
					</h3>
					<ul class="breadcrumb">
						<li>
							<i class="icon-home"></i>
						...
						<li>
							<a href="/<?php echo $mod ?>">Chuyên gia</a>
							<i class="icon-angle-right"></i>
						</li>
    ...
    ?>
        ...
        ?>
                                <div class="portlet box blue">
        							...
        							<div class="portlet-body">
                                        <div class="controls controls-row">
                                            <a href="/chuyengia/delete?id=<?php echo $_GET['id'] ?>" title="" class="btn_trash">Xóa vĩnh viễn</a>
                                            <a href="/chuyengia/restore?id=<?php echo $_GET['id'] ?>" class="btn green pull-right"><i class="icon-undo"></i> Phục hồi</a>
                                        </div>                                                                                                                                                     
        							</div>
        						</div>
                                <?php
