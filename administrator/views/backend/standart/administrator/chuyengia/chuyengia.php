...
<div class="page-container row-fluid">
    ...
    ?>
                            ...
                            <a href="/chuyengia" class="btn green pull-right"><i class="icon-reorder"></i> Danh sách</a>
                        <?php
} else {
        ?>
                            <a href="/chuyengia/add" class="btn green pull-right"><i class="icon-plus"></i> Thêm mới</a>
                            <a href="/chuyengia?is_trash=1" class="btn pull-right"><i class="icon-trash"></i> Thùng rác</a>
                        <?php
    } ?>
					</h3>
							...
							<tr class="odd gradeX">
								<td>
                                    <div class="field_title">
                                        <a href="<?php echo '/chuyengia/edit?id='.$oneItem[$pkeyTable]; ?>"><?php echo $oneItem['title'] ?></a>
                                    </div>
                                </td>
							</tr>
                            <?php
