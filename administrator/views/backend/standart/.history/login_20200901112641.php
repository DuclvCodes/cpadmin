						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form" action="" method="post" autocomplete="off">
								<div class="form-group">
									<input class="form-control m-input h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" autocomplete="off" placeholder="Tên đăng nhập" name="user_name" value="" tabindex="1"/>
								</div>
								<div class="form-group">
