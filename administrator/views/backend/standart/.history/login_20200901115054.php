				...
				<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
					<div class="d-flex flex-column flex-root">
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3 class="opacity-40 font-weight-normal">Đăng nhập hệ thống CMS</h3>
							</div>
							<form class="form" id="kt_login_signin_form" action="" method="post" autocomplete="off">
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" autocomplete="off" placeholder="Tên đăng nhập" name="user_name" value="" tabindex="1"/>
								</div>
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="password" autocomplete="off" placeholder="Mật khẩu" name="user_pass" tabindex="2" />
								</div>
								...
								<div class="form-group text-center mt-10">
									<button class="btn btn-pill btn-primary opacity-90 px-15 py-3" id="" type="submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">Sign In</button>
								</div>
							</form>
						</div>
						...
						<div class="login-forgot">
							<span class="opacity-40 font-weight-normal">
								Quên mật khẩu ?
							</span>&nbsp;&nbsp;
							<p class="opacity-40 mr-4">Liên hệ bộ phận kĩ thuật hoặc thư ký tòa soạn để cấp lại mật khẩu<a href="javascript:;"  id="m-login__forget-password" class=""></a>.</p>
						</div>
					</div>
				</div>
			</div>
