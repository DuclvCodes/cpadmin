...
class Chuyengia extends Admin
{
    ...
    public function index()
    {
        ...
        $this->load->model('Chuyengia_model');
        $clsClassTable = new Chuyengia_model();
        ...
        /*=============Content Page==================*/
        $this->render('backend/standart/administrator/chuyengia/chuyengia', $assign_list);
    }
    public function add()
    {
        $assign_list['mod'] = 'chuyengia';
        ...
        if ($this->input->post() && $this->input->post('title')) {
            ...
            if ($clsClassTable->insertOne($_POST)) {
                ...
                redirect('/chuyengia/edit?id='.$maxId.'&mes=insertSuccess');
            } else {
        ...
        $assign_list['keyword_page'] = '';
        /*=============Content Page==================*/
        $this->render('backend/standart/administrator/chuyengia/add', $assign_list);
    }
    public function edit()
    {
        ...
        if ($this->input->post() && $this->input->post('title')) {
            ...
            if ($clsClassTable->updateOne($id, $data)) {
                ...
                redirect('/chuyengia/edit?id='.$_GET['id']);
            } else {
                foreach ($this->input->post() as $key => $val) {
                    $assign_list[$key] = $val;
                }
        ...
        $assign_list['keyword_page'] = '';
        /*=============Content Page==================*/
        $this->render('backend/standart/administrator/chuyengia/edit', $assign_list);
    }
