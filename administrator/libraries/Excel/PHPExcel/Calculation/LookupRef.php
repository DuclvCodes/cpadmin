...
class PHPExcel_Calculation_LookupRef
{
    ...
    public static function INDIRECT($cellAddress = null, PHPExcel_Cell $pCell = null)
    {
        ...
        if ((!preg_match('/^'.PHPExcel_Calculation::CALCULATION_REGtkp_CELLREF.'$/i', $cellAddress1, $matches)) ||
            ((!is_null($cellAddress2)) && (!preg_match('/^'.PHPExcel_Calculation::CALCULATION_REGtkp_CELLREF.'$/i', $cellAddress2, $matches)))) {
            if (!preg_match('/^'.PHPExcel_Calculation::CALCULATION_REGtkp_NAMEDRANGE.'$/i', $cellAddress1, $matches)) {
                return PHPExcel_Calculation_Functions::REF();
            }
