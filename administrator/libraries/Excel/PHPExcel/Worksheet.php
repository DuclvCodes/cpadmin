...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    public function getCell($pCoordinate = 'A1', $createIfNotExists = true)
    {
        ...
        // Named range?
        if ((!preg_match('/^'.PHPExcel_Calculation::CALCULATION_REGtkp_CELLREF.'$/i', $pCoordinate, $matches)) &&
            (preg_match('/^'.PHPExcel_Calculation::CALCULATION_REGtkp_NAMEDRANGE.'$/i', $pCoordinate, $matches))) {
