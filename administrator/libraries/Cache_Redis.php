...
class Cache {
	 ...
	 * @return bool
	*/
	public function set ($value, $key, $expire=43200) { 
		if (!$this->_USE_CACHE) {
			return false;
		}
        ...
        //if($expire) $this->CI->redis->command("EXPIRE ".$cacheKey." ".$expire);
		if ($result) {
			return true;
		} else {
			return false;
	...
	*/
    ...
    public function flush() {
        $this->CI->redis->command('flushall');
        //$this->CI->redis->_clear_socket();
    }
}