...
class Cache
{
    ...
    */
    ...
    +-------------------------------------+
    */
    public function write($value = null,$key = null, $expiration = null)
    {
        ...
        if (is_array($key)) {
            foreach ($key as $multi) {
                ...
                $this->add( $multi['value'],$this->key_name($multi['key']), $multi['expiration']);
            }
        } else {
            switch ($this->client_type) {
                case 'Memcache':
    ...
    +-------------------------------------+
    */
    public function set($value = null, $key = null, $expiration = null)
    {
        if (is_null($expiration)) {
            $expiration = $this->config['config']['expiration'];
        }
        if (is_array($key)) {
            foreach ($key as $multi) {
                ...
                $this->set($multi['value'], $this->key_name($multi['key']), $multi['expiration']);
            }
        } else {
            switch ($this->client_type) {
                case 'Memcache':
    ...
    */
    ...
    +-------------------------------------+
    */
    public function replace($value = null, $key = null, $expiration = null)
    {
        if (is_null($expiration)) {
            $expiration = $this->config['config']['expiration'];
        }
        if (is_array($key)) {
            foreach ($key as $multi) {
                ...
                $this->replace($multi['value'], $multi['key'], $multi['expiration']);
            }
        } else {
            switch ($this->client_type) {
                case 'Memcache':
